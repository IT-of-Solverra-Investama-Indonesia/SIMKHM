            ...
            <div class="col-12">
              <div class="card">
                ...
                <?php 
                  ...
                  $koneksi->query("CREATE TABLE IF NOT EXISTS hari SELECT DATE_FORMAT(jadwal, '%y/%m') as bulan, DATE_FORMAT(jadwal, '%y-%m-%d') as hari from registrasi_rawat group by bulan,hari ");
                  
                  $koneksi->query("DROP TABLE hari_jumlah");
                  $koneksi->query(" CREATE TABLE IF NOT EXISTS hari_jumlah SELECT bulan, count(hari) as harii from hari group by bulan");
                ...
                <?php 
                  ...
                  $koneksi->query("CREATE TABLE IF NOT EXISTS poli_jumlah SELECT DATE_FORMAT(jadwal, '%y/%m') as bulan, SUM(IF(carabayar='umum',1,0)) AS umum, SUM(IF(carabayar='bpjs',1,0)) AS bpjs, SUM(IF(carabayar='malam',1,0)) AS malam,COUNT(no_rm) AS jumlah FROM registrasi_rawat where datang = 1 group by bulan order by bulan desc");
