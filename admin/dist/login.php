        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <h2  style="margin-top:1px; font-weight: bold; color:darkblue">SIM KHM</h2>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <select id="inputState" name="dokter_rawat" class="form-select">
                    ...
                    <?php $dokter = $koneksi->query("SELECT *,  SUBSTRING(namalengkap, 4) AS namaDokter FROM admin where level = 'dokter' ORDER BY namaDokter ASC"); foreach($dokter as $dok){ ?>
                    ...
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Shift</label>
