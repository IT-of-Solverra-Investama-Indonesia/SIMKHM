<?php if (!isset($_GET['room'])) { ?>
    <h3>Daftar Chat Konsultasi ALL</h3>
    <?php
        $getRoom = $koneksi->query("SELECT * FROM room_konsultasi ORDER BY created_at DESC");
    ...
    ?>
        ...
        <?php if (!empty($getPesan)) { ?>
            <a href="index.php?halaman=konsultasiall&room=<?= $data['id'] ?>" class="text-dark link-dark">
...
<?php } else { ?>
    ...
    <div class="row mb-1">
        <div class="col-12">
            <a href="index.php?halaman=konsultasiall" style="max-width: 100px;" class="btn btn-sm btn-dark">Kembali</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchMessages() {
                $.ajax({
                    url: '../../kosmetik/chat_api.php?getPesan=<?= $_GET['room'] ?>',
                    method: 'GET',
                    dataType: 'json',
