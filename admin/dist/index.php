  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      if ($_SESSION['admin']['level'] == 'apoteker' or $_SESSION['admin']['level'] == 'racik') {
        $getRegistrasiInap = $koneksi->query("SELECT COUNT(*) as total FROM `ctt_penyakit_inap` WHERE plan_at IS NULL AND (plan LIKE '%obat lanjut%' OR plan LIKE '%pulang%')")->fetch_assoc();
