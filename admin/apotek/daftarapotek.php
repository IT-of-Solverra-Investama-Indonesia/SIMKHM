      ...
      <div class="card">
        <div class="card-body">
            <div style="margin-top: 10px;  text-align: right;">
              <a href="index.php?halaman=tambah_obatmasuk" class="btn btn-sm btn-primary"><i class="bi bi-plus"></i> Pesan Obat</a>
              <a href="index.php?halaman=apotek_terima" class="btn btn-sm btn-primary"><i class="bi bi-plus"></i> Terima Obat</a>
              <a href="index.php?halaman=daftar_obat_selaras" class="btn btn-sm btn-warning">Penyelarasan</a>
              <a href="index.php?halaman=harga_beli_tarakhir" class="btn btn-sm btn-success">Harga Beli Terakhir</a>
              <?php if($_SESSION['admin']['level'] == 'sup'){?>
                <a href="index.php?halaman=daftar_obat_master" class="btn btn-sm btn-danger">Obat Master</a>
              <?php }?>
            </div>
