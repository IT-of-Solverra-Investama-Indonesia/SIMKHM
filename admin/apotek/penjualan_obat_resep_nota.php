...
$total = 0;
$getDataSingle = $koneksi->query("SELECT * FROM penjualan_resep WHERE nota = '" . htmlspecialchars($_GET['nota']) . "' ORDER BY id_penjualan DESC LIMIT 1")->fetch_assoc();
?>
...
<div style="max-width: 58mm; padding: 2mm;">
    ...
    <?php
    $getData = $koneksi->query("SELECT * FROM penjualan_resep WHERE nota = '" . htmlspecialchars($_GET['nota']) . "' ORDER BY id_penjualan DESC");
