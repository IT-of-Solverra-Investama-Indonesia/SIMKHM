<div class="card shadow p-2 mb-2">
    <h5 class="m-0">Rekap Kunjungan Perawat Poli</h5>
    <form method="get">
        <div class="row g-1">
            <input type="text" name="halaman" value="dashboardstaff" hidden id="">
            <input type="text" name="tipe" value="rekapKunjunganPerawatPoli" hidden id="">
            <div class="col-9">
...
<div class="card shadow p-2">
    <div class="table-responsive">
        <table class="table table-striped table-hover table-sm" style="font-size: 12px;">
            ...
            <tbody>
                <?php
                $getData = $koneksi->query("SELECT DATE_FORMAT(jadwal, '%Y-%m') as bulan, perawat, COUNT(*) as JumlahPasienPoliDatang FROM registrasi_rawat WHERE perawatan = 'Rawat Jalan' AND status_antri != 'Belum Datang' and DATE_FORMAT(jadwal, '%Y-%m') = '$bulanSaatIni' GROUP BY DATE_FORMAT(jadwal, '%Y-%m'), perawat ORDER BY jadwal DESC");
