...
<div class="card shadow-sm p-2 mb-1">
    <form method="post">
        <div class="row">
            <div class="col-3">
                <input placeholder="Dari Tanggal" name="tgl_start" class="form-control mb-2" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" />
            </div>
            <div class="col-3">
                <input placeholder="Hingga Tanggal" name="tgl_end" class="form-control mb-2" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" />
            </div>
            <div class="col-3">
...
<?php 
    if(isset($_POST['src'])){
        echo "
            <script>
                document.location.href='index.php?halaman=gajidokter_history&src&tgl_start=".htmlspecialchars($_POST['tgl_start'])."&tgl_end=".htmlspecialchars($_POST['tgl_end'])."&dokter=".htmlspecialchars($_POST['dokter'])."&akun=".htmlspecialchars($_POST['akun'])."';
            </script>
        ";
    }
?>
