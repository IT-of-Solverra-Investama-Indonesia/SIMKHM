<?php
// error_reporting(0);
$getDataSingle = $koneksi->query("SELECT * FROM kajian_awal WHERE id_rm = '".htmlspecialchars($_GET['id'])."' ORDER BY tgl_rm DESC LIMIT 1;");
$awal = $getDataSingle->fetch_assoc();
                      ...
                      <div class="col-md-6">
                       ...
                       <div class="col-md-6">
                        ...
                        <input value="-" type="text" class="form-control"  name="gigi" id="inputName5" placeholder="Gigi Geligi">
                                        ...
                                        <!-- <h5 class="card-title">Pemeriksaan Fisik</h5> -->
                                        <?php
                                        $getPemeriksaanFisik = $koneksi->query("SELECT *, COUNT(*) AS jumData FROM pemeriksaan_fisik WHERE id_regis = '$pasien[idrawat]' AND norm = '$pasien[no_rm]' ORDER BY id DESC LIMIT 1")->fetch_assoc();
                                        ?>
                                        ...
                                        <div class="text-center" style="margin-top: 50px; margin-bottom: 80px;">
                                            <?php
                                            $tes = $koneksi->query("SELECT * FROM kajian_awal WHERE id_rm = '$awal[id_rm]';")->fetch_assoc();
                        ...
                        <div class="col-md-12">
                            <div class="card shadow p-3">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        $getKajiaAwal = $koneksi->query("SELECT * FROM kajian_awal WHERE id_rm = '$awal[id_rm]' LIMIT 1");
...
if (isset($_POST['save'])) {
    ...
    // Update query for kajian_awal table
    $koneksi->query("UPDATE kajian_awal SET 
        keluhan_utama='$keluhan_utama', 
        riwayat_penyakit='$riwayat_penyakit', 
        pemberian_vaksin='$pemberian_vaksin',  
        ...
        fungsional_cacat='$_POST[fungsional_cacat]', 
        fungsional_alat='$_POST[fungsional_alat]', 
        no1='$no1', 
        no2='$no2', 
        no3='$no3', 
        no4='$no4', 
        ...
        norm='$norm', 
        psiko='$psiko', 
        diagnois_prwt='$_POST[diagnois_prwt]', 
        rencana_asuh='$_POST[rencana_asuh]', 
        oksigen='$_POST[oksigen]' 
        WHERE id_rm='$awal[id_rm]'");

    // Update query for pasien table
    $koneksi->query("UPDATE pasien SET 
        umur='$umur_pasien', 
        pekerjaan='$pekerjaan', 
        status_nikah='$status_nikah' 
        WHERE no_rm='$awal[norm]';");

    // Update query for log_user table
    $koneksi->query("UPDATE log_user SET 
    ...
    // Update query for pemeriksaan_fisik table
    $koneksi->query("UPDATE pemeriksaan_fisik SET 
        gcs_e='$gcs_e', 
        gcs_v='$gcs_v', 
        gcs_m='$gcs_m', 
        rangsangan_meninggal='$rangsangan_meninggal', 
        refleks_fisiologis1='$refleks_fisiologis1', 
        refleks_fisiologis2='$refleks_fisiologis2', 
        refleks_patologis='$refleks_patologis', 
        flat='$flat', 
        hl='$hl', 
        assistos='$assistos', 
        thympani='$thympani', 
        soepel='$soepel', 
        ntf_atas_kiri='$ntf_atas_kiri', 
        ntf_atas='$ntf_atas', 
        ntf_atas_kanan='$ntf_atas_kanan', 
        ntf_tengah_kiri='$ntf_tengah_kiri', 
        ntf_tengah='$ntf_tengah', 
        ntf_tengah_kanan='$ntf_tengah_kanan', 
        ntf_bawah_kiri='$ntf_bawah_kiri', 
        ntf_bawah='$ntf_bawah', 
        ntf_bawah_kanan='$ntf_bawah_kanan', 
        bu='$bu', 
        bu_komen='$bu_komen', 
        anemis_kiri='$anemis_kiri', 
        anemis_kanan='$anemis_kanan', 
        ikterik_kiri='$ikterik_kiri', 
        ikterik_kanan='$ikterik_kanan', 
        rcl_kiri='$rcl_kiri', 
        rcl_kanan='$rcl_kanan', 
        ...
        torax='$torax', 
        retraksi='$retraksi', 
        vesikuler_kiri='$vesikuler_kiri', 
        vesikuler_kanan='$vesikuler_kanan', 
        wheezing_kiri='$wheezing_kiri', 
        wheezing_kanan='$wheezing_kanan', 
        rongki_kiri='$rongki_kiri', 
        rongki_kanan='$rongki_kanan', 
        s1s2='$s1s2', 
        murmur='$murmur', 
        golop='$golop', 
        nch_kiri='$nch_kiri', 
        nch_kanan='$nch_kanan', 
        polip_kiri='$polip_kiri', 
        polip_kanan='$polip_kanan', 
        conca_kiri='$conca_kiri', 
        conca_kanan='$conca_kanan', 
        faring_hipertermis='$faring_hipertermis', 
        halitosis='$halitosis', 
        pembesaran_tonsil='$pembesaran_tonsil', 
        serumin_kiri='$serumin_kiri', 
        serumin_kanan='$serumin_kanan', 
        typani_intak_kiri='$typani_intak_kiri', 
        typani_intak_kanan='$typani_intak_kanan', 
        pembesaran_getah_bening='$pembesaran_getah_bening', 
        akral_hangat_atas_kiri='$akral_hangat_atas_kiri', 
        akral_hangat_atas_kanan='$akral_hangat_atas_kanan', 
        akral_hangat_bawah_kiri='$akral_hangat_bawah_kiri', 
        akral_hangat_bawah_kanan='$akral_hangat_bawah_kanan', 
        oe_atas_kiri='$oe_atas_kiri', 
        oe_atas_kanan='$oe_atas_kanan', 
        oe_bawah_kiri='$oe_bawah_kiri', 
        oe_bawah_kanan='$oe_bawah_kanan', 
        crt='$crt', 
        motorik_atas_kiri='$motorik_atas_kiri', 
        motorik_atas_kanan='$motorik_atas_kanan', 
        motorik_bawah_kiri='$motorik_bawah_kiri', 
        motorik_bawah_kanan='$motorik_bawah_kanan', 
        kognitif='$kognitif' 
        WHERE id_regis='$pasien[idrawat]' AND norm='$pasien[no_rm]'");

    if (mysqli_affected_rows($koneksi) > 0) {
        echo "
      <script>
        alert('Data berhasil diupdate');
        document.location.href='index.php?halaman=resumeedit&id=".htmlspecialchars($_GET['id'])."';
      </script>
    ";
    } else {
        echo "
