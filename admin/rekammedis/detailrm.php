        ...
        <div class="">
          <div class="">
            <div class="">
              ...
              ?>
                <p class="mb-1 mt-0" align="right">
                  <a target="_blank" href="../rekammedis/e-resep.php?id=<?= $_GET['id'] ?>&tgl=<?= $_GET['tgl'] ?>&idrekammedis=<?= $_GET['idrekammedis'] ?>" class="btn btn-sm btn-secondary mt-0"><i class="bi bi-printer mt-3"></i> Print</a>
                </p>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-3">
                        ...
                        <h6 type="text" id="h6City" placeholder="Masukkan Email Pasien" name="anamnesa"><?php echo $start['perawatan'] ?></h6>
                      </div>
                      <div class="col-md-3">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-3">
                        <b><label for="h6State" class="form-label">Diagnosis</label></b>
                        <h6 type="text" id="h6City" placeholder="Masukkan Email Pasien" name="anamnesa"><?php echo (isset($rm['diagnosis']) or $rm['diagnosis'] == '') ? $rm['diagnosis'] : $pasien['diagnosis_prwt']; ?></h6>
                      </div>

                      <div class="col-md-3">
                        <b><label for="h6State" class="form-label">BB</label></b>
                        <h6 type="text" id="h6City" placeholder="Masukkan Email Pasien" name="anamnesa"><?php echo $pasien['bb'] ?> Kg</h6>
                      </div>
                    ...
                    <form action="" method="post">
                      ...
                      <?php if ($cekr['jumlah'] == 0) { ?>
                        ...
                        <div class="card shadow p-2">
                          ...
                          if ($obatt->num_rows == 0) {
                            $obatt = $koneksi->query("SELECT * FROM obat_rm  WHERE idrm = '$_GET[id]' AND DATE_FORMAT(tgl_pasien, '%Y-%m-%d') = DATE_FORMAT('$_GET[tgl]', '%Y-%m-%d')");
                          }
                          ?>
                          <center>
                            <p></p>PIO</p>
