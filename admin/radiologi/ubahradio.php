    ...
    <div class="container">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Ubah Radiologi</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body">
              ...
              <div class="row">
                 <div class="col-md-6" style="margin-top:10px;">
                  ...
                  <input type="text" class="form-control" name="dokter_pengirim_radio" value="<?php echo $radio['dokter_pengirim_radio']?>" id="inputName5" placeholder="Masukkan Nama Dokter">
                </div>
                <div class="col-md-6" style="margin-top:10px;">
                  <label for="inputName5" class="form-label">No Hp Dokter</label>
                  <input type="text" class="form-control" name="notelp_dokter_radio" id="inputName5" value="<?php echo $radio['notelp_dokter_radio']?>" placeholder="Masukkan No Dokter">
                </div>
              ...
              <div class="row">
                 <div class="col-md-6" style="margin-top:5px;">
                  ...
                  <input type="text" class="form-control" name="faskes_pengirim_radio" value="<?php echo $radio['faskes_pengirim_radio']?>" id="inputName5" placeholder="Nama Fasilitas Pelayanan Kesehatan yang mengirimkan permintaan Radiologi (rujukan dari luar)">
                </div>
                <div class="col-md-6" style="margin-top:5px;">
                  <label for="inputName5" class="form-label">Unit Pengirim</label>
                  <input type="text" class="form-control" name="unit_pengirim_radio" id="inputName5" value="<?php echo $radio['unit_pengirim_radio']?>" placeholder="Unit internal RS yang melakukan pengiriman spesimen">
                </div>
              ...
              <div class="row">
               <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="nama_pemeriksaan_radio" id="inputName5" value="<?php echo $radio['nama_pemeriksaan_radio']?>" placeholder="Masukkan Pemeriksaan Pasien">
                </div>
                <div class="col-md-6">
                  <label for="inputName5" class="form-label">No Permintaan Rujukan</label>
                  <input type="text" class="form-control" id="inputName5" value="<?php echo $radio['no_permintaan_radio']?>" name="no_permintaan_radio" placeholder="No Radiologi">
                </div>
                 <div class="col-md-12" style="margin-top:20px;">
                  <label for="inputName5" class="form-label">Waktu Permintaan</label>
                  <input type="datetime-local" class="form-control" id="inputName5" name="waktu_permintaan_radio" value="<?php echo $radio['waktu_permintaan_radio']?>" placeholder="Masukkan Nama Pasien">
                </div>
                ...
                <div class="col-md-12" style="margin-top:20px;">
                  ...
                  <input type="text" class="form-control" id="inputName5" name="diagnosis_radio" value="<?php echo $radio['diagnosis_radio']?>" placeholder="Masukkan Diagnosis/Masalah Pasien">
                </div>
                <div class="col-md-12" style="margin-top:20px;">
                  <label for="inputName5" class="form-label">Catatan Permintaan</label>
                  <input type="text" class="form-control" id="inputName5" name="ctt_permintaan_radio" value="<?php echo $radio['ctt_permintaan_radio']?>" placeholder="Masukkan Catatan Permintaan">
                </div>
                <div class="col-md-12" style="margin-top:20px;">
                ...
                <div class="col-md-12" style="margin-top:20px;">
                 ...
                 <div class="col-md-12" style="margin-top:20px;">
                  ...
                  <input type="datetime-local" class="form-control" id="inputName5" name="tgl_periksa_radio" value="<?php echo $radio['tgl_periksa_radio']?>" placeholder="Masukkan Catatan Permintaan">
                </div>
                 <div class="col-md-12" style="margin-top:20px;">
                  <label for="inputName5" class="form-label">Jenis Bahan</label>
                  <input type="text" class="form-control" id="inputName5" name="jenis_bahan" value="<?php echo $radio['jenis_bahan']?>" placeholder="Nama bahan kontras yang digunakan untuk pemeriksaan radiologi">
                </div>
                 <div class="col-md-12" style="margin-top:20px;">
                  <label for="inputName5" class="form-label">Foto Pemeriksaan</label><br>
                  <img style="border-radius: 5px; width:90px; margin-bottom: 5px;" src="../radiologi/foto/<?php echo $radio['foto_periksa_radio'] ?>" alt="Profile">
                  <input type="file" class="form-control" id="inputName5" name="foto_periksa_radio">
                </div>
                <div class="col-md-12" style="margin-top:20px;">
                 ...
                 <div class="col-md-12" style="margin-top:20px;">
                  ...
                  <input type="text" class="form-control" id="inputName5" name="dokter_inter" value="<?php echo $radio['dokter_inter']?>" placeholder="Nama Dokter yang Menginterpretasi Hasil Pemeriksaan">
                </div>
                 <div class="col-md-12" style="margin-top:20px;">
                  <label for="inputName5" class="form-label">Interpretasi Radiologi</label>
                  <input type="text" class="form-control" id="inputName5" name="inter_radio" value="<?php echo $radio['inter_radio']?>" placeholder="Pembacaan dari hasil pemindaian radiologi oleh dokter spesialis radiologi yang terdiri dari deskripsi dan konklusi">
                </div>
...
if (isset ($_POST['save'])) {
  ...
  move_uploaded_file($lokasi, '../radiologi/foto/'.$foto_periksa_radio);
   ...
   $koneksi->query("UPDATE radiologi SET no_rm='$no_rm', nama_pasien='$nama_pasien', nama_pemeriksaan_radio='$nama_pemeriksaan_radio', no_permintaan_radio='$no_permintaan_radio', waktu_permintaan_radio='$waktu_permintaan_radio', dokter_pengirim_radio='$dokter_pengirim_radio', notelp_dokter_radio='$notelp_dokter_radio', prioritas_periksa_radio='$prioritas_periksa_radio', diagnosis_radio='$diagnosis_radio', ctt_permintaan_radio='$ctt_permintaan_radio', metode_hasil_radio='$metode_hasil_radio', jenis_pemeriksaan_radio='$jenis_pemeriksaan_radio', faskes_pengirim_radio='$faskes_pengirim_radio', unit_pengirim_radio='$unit_pengirim_radio', status_alergi_radio='$status_alergi_radio', foto_periksa_radio='$foto_periksa_radio',status_kehamilan='$status_kehamilan',tgl_periksa_radio='$tgl_periksa_radio',jenis_bahan='$jenis_bahan',dokter_inter='$dokter_inter',inter_radio='$inter_radio' WHERE idradio='$_GET[id]' ");
    ...
    // ");
     ...
     $koneksi->query("UPDATE radiologi SET no_rm='$no_rm', nama_pasien='$nama_pasien', nama_pemeriksaan_radio='$nama_pemeriksaan_radio', no_permintaan_radio='$no_permintaan_radio', waktu_permintaan_radio='$waktu_permintaan_radio', dokter_pengirim_radio='$dokter_pengirim_radio', notelp_dokter_radio='$notelp_dokter_radio', prioritas_periksa_radio='$prioritas_periksa_radio', diagnosis_radio='$diagnosis_radio', ctt_permintaan_radio='$ctt_permintaan_radio', metode_hasil_radio='$metode_hasil_radio', jenis_pemeriksaan_radio='$jenis_pemeriksaan_radio', faskes_pengirim_radio='$faskes_pengirim_radio', unit_pengirim_radio='$unit_pengirim_radio', status_alergi_radio='$status_alergi_radio',status_kehamilan='$status_kehamilan',tgl_periksa_radio='$tgl_periksa_radio',jenis_bahan='$jenis_bahan',dokter_inter='$dokter_inter',inter_radio='$inter_radio' WHERE idradio='$_GET[id]' ");
...
if (mysqli_affected_rows($koneksi)>0) {
  echo "
    ...
    document.location.href='index.php?halaman=detailradio&id=".$radio["idradio"]."';
