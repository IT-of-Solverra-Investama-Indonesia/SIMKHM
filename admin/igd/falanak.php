...
$pasien = $koneksi->query("SELECT * FROM igd WHERE no_rm='$_GET[id]'");
$pecah = $pasien->fetch_assoc();
$fal = $koneksi->query("SELECT * FROM humpty_igd WHERE no_rm='$_GET[id]' AND tipe!= 'inap'");
?>
              ...
              <div class="col-md-12">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <input type="text" name="ruang" id="" value="IGD" hidden>
