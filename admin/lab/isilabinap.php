...
<form class="row" method="post" enctype="multipart/form-data">
   <div class="container">
              ...
              <!-- Multi Columns Form -->
                ...
                <div class="col-md-12">
                 ...
                 <div class="col-md-12">
                  ...
                  <input type="date" class="form-control" name="tgl_hasil[]" id="inputName5" placeholder="Masukkan Nama Pasien" style="width: 1000px;" value="<?= $_GET['tgl'] ?>"> <p style="color:orangered;">*harap isi sesuai tgl rujuk lab</p>
                </div>
                <input type="hidden" class="form-control" name="id_inap[]" id="inputName5" value="<?php echo $pecah['id_lab_inap'] ?>" placeholder="Masukkan Nama Pasien"> 
                <input type="hidden" class="form-control" name="id" id="inputName5" value="<?php echo $pecah['id_lab_inap'] ?>" placeholder="Masukkan Nama Pasien"> 
    ...
    <tbody>
      ...
      <?php 
      $result1 = $koneksi->query("SELECT sum(biaya) FROM lab WHERE id_lab_inap='$id' AND tgl='$tanggal';");
...
$koneksi->query("INSERT rawatinapdetail SET 
