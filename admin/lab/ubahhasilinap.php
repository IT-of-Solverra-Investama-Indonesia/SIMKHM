...
$ambil=$koneksi->query("SELECT * FROM lab WHERE id_lab_inap='$id'");
$ambil2=$koneksi->query("SELECT * FROM lab_hasil WHERE id_inap='$id' AND DATE(tgl_hasil)='$tanggal'  ");
...
<form class="row" method="post" enctype="multipart/form-data">
   <div class="container">
    ...
    <tbody>
      ...
      <?php 
      $result1 = $koneksi->query("SELECT sum(biaya) FROM lab WHERE id_lab_inap='$_GET[id]' AND tgl='$tanggal'");
...
if (isset ($_POST['save'])) {
    ...
    for ($i = 0; $i < $jumlahFile; $i++) {
        ...
        $koneksi->query("UPDATE lab_hasil SET
            ...
            WHERE idhasil = '$idhasil[$i]' AND DATE(tgl_hasil)='$tanggal';
...
// $koneksi->query("UPDATE rawatinapdetail SET 
