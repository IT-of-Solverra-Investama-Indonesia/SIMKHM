...
$ambil=$koneksi->query("SELECT * FROM daftartes WHERE idtes = '$_GET[id]' ");
          ...
          <div class="row">
              <!-- Multi Columns Form -->
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="nama_tes" id="inputName5" value="<?php echo $pecah["nama_tes"]; ?>" placeholder="Masukkan Nama Pemeriksaan" style="width: 1000px;" >
                </div>
                <div class="col-md-12">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Nilai Normal</label>
                  <input type="text" class="form-control" name="indikator" id="inputName5" value="<?php echo $pecah["indikator"]; ?>" placeholder="Masukkan Nilai Normal" style="width: 1000px;">
                </div>
                <div class="col-md-12">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Tipe</label>
                  <select type="text" class="form-control" name="tipe" id="inputName5" value="<?php echo $pecah["tipe"]; ?>" placeholder="Masukkan Tipe" style="width: 1000px;">
                    <option value="<?php echo $pecah["tipe"]; ?>"><?php echo $pecah["tipe"]; ?></option>
                ...
                <div class="col-md-12" style="margin-bottom:20px">
                  ...
                  <input type="number" class="form-control" name="harga_lab" id="inputName5" value="<?php echo $pecah["harga_lab"]; ?>" placeholder="Masukkan Harga (hanya angka, tidak memakai karakter titik/koma)" style="width: 1000px;">
                </div>
...
if (isset ($_POST['save'])) {
    ...
    $harga_lab=$_POST['harga_lab'];
        ...
        $koneksi->query("UPDATE daftartes SET nama_tes='$nama_tes', indikator='$indikator', tipe='$tipe', harga_lab='$harga_lab' WHERE idtes='$_GET[id]' ");
