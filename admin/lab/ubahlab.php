            ...
            <div class="card-body col-md-12">
              ...
              <!-- Multi Columns Form -->
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="norm" id="inputName5" value="<?php echo $pecah['norm']?>" placeholder="Masukkan Nama Pasien">
                </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                 <div class="col-md-6" style="margin-top:20px;">
                  ...
                  <input type="text" class="form-control" name="dokter_pengirim" value="<?php echo $pecah['dokter_pengirim']?>" id="inputName5" placeholder="Masukkan Nama Dokter">
                </div>
                <div class="col-md-6" style="margin-top:20px;">
                  <label for="inputName5" class="form-label">No Hp Dokter</label>
                  <input type="text" class="form-control" name="notelp_dokter" id="inputName5" value="<?php echo $pecah['notelp_dokter']?>" placeholder="Masukkan No Dokter">
                </div>
              ...
              <div class="row">
               <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="nama_pemeriksaan" id="inputName5" value="<?php echo $pecah['nama_pemeriksaan']?>" placeholder="Masukkan Pemeriksaan Pasien">
                </div>
                <div class="col-md-6">
                  <label for="inputName5" class="form-label">No Permintaan Rujukan</label>
                  <input type="text" class="form-control" id="inputName5" value="<?php echo $pecah['no_permintaan']?>" name="no_permintaan" placeholder="No Rujukan">
                </div>
                 <div class="col-md-12" style="margin-top:20px;">
                  <label for="inputName5" class="form-label">Waktu Permintaan</label>
                  <input type="datetime-local" class="form-control" id="inputName5" name="waktu_permintaan" value="<?php echo $pecah['waktu_permintaan']?>" placeholder="Masukkan Nama Pasien">
                </div>
                <div class="col-md-12" style="margin-top:20px;">
                ...
                <div class="col-md-12" style="margin-top:20px;">
                  ...
                  <input type="text" class="form-control" id="inputName5" name="diagnosis" value="<?php echo $pecah['diagnosis']?>" placeholder="Masukkan Diagnosis/Masalah Pasien">
                </div>
                <div class="col-md-12" style="margin-top:20px;">
                  <label for="inputName5" class="form-label">Catatan Permintaan</label>
                  <input type="text" class="form-control" id="inputName5" name="ctt_permintaan" value="<?php echo $pecah['ctt_permintaan']?>" placeholder="Masukkan Catatan Permintaan">
                </div>
                <div class="col-md-12" style="margin-top:20px;">
            ...
            <div class="card-body col-md-12">
              ...
              <!-- Multi Columns Form -->
                 <div class="col-md-12" style="margin-top:20px;">
                  ...
                  <select id="inputState" name="asal_spesimen" class="form-select">
                ...
                <div class="col-md-12" style="margin-top:10px;">
                  ...
                  <input type="text" class="form-control" name="lokasi_spesimen" id="inputName5" value="<?php echo $pecah['lokasi_spesimen']?>" placeholder="Bagian anggota tubuh dimana jaringan diambil">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Jumlah Spesimen Klinis</label>
                  <input type="number" class="form-control" name="jml_spesimen" id="inputName5" value="<?php echo $pecah['jml_spesimen']?>" placeholder="Jumlah potongan/slice jaringan yang diambil">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Volume Spesimen Klinis</label>
                  <input type="text" class="form-control" name="vol_spesimen" id="inputName5" value="<?php echo $pecah['vol_spesimen']?>" placeholder="Jumlah potongan/slice jaringan yang diambil (ml)">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Cara / Metode Pengambilan Spesimen Klinis</label>
                  <input type="text" class="form-control" name="metode_spesimen" id="inputName5" value="<?php echo $pecah['metode_spesimen']?>" placeholder="Cara pengambilan jaringan dengan menggunakan metode tertentu">
                </div>
                 <div class="col-md-12" style="margin-top:20px;">
                  <label for="inputName5" class="form-label">Waktu Pengambilan Spesimen</label>
                  <input type="datetime-local" class="form-control" id="inputName5" name="waktu_spesimen" value="<?php echo $pecah['waktu_spesimen']?>" placeholder="Masukkan Nama Pasien">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Kondisi Spesimen Klinis</label>
                  <input type="text" class="form-control" name="kondisi_spesimen" id="inputName5" value="<?php echo $pecah['kondisi_spesimen']?>" placeholder="Kualitas fisik pada saat pengambilanspesimen/jaringan (warna, bau,kekeruhan, dst)">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Waktu Fiksasi Spesimen Klinis</label>
                  <input type="datetime-local" class="form-control" name="waktu_fik_spesimen" id="inputName5" value="<?php echo $pecah['waktu_fik_spesimen']?>" placeholder="Waktu ketika fiksasi jaringan dilakukan">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Cairan Fiksasi</label>
                  <input type="text" class="form-control" name="cairan_fik" id="inputName5" value="<?php echo $pecah['cairan_fik']?>" placeholder="Nama bahan cairan fiksasi yang digunakan untuk fiksasi pada jaringan">
                </div>
                  <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Volume Cairan Fiksasi</label>
                  <input type="text" class="form-control" name="vol_fik" id="inputName5" value="<?php echo $pecah['vol_fik']?>" placeholder="Jumlah kuantitas dari cairan fiksasi yang digunakan pada spesimen">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Nama Petugas yang Mengambil Spesimen Klinis</label>
                  <input type="text" class="form-control" name="nama_ptgs_ambil" id="inputName5" value="<?php echo $pecah['nama_ptgs_ambil']?>" placeholder="Nama Lengkap Sesuai KTP">
                </div>
                  <div class="col-md-12" style="margin-top:10px;">
                <label for="inputName5" style="margin-top: 10px;" class="form-label">Nama Petugas yang Mengantar Spesimen Klinis</label>
                  <input type="text" class="form-control" name="nama_ptgs_antar" id="inputName5" value="<?php echo $pecah['nama_ptgs_antar']?>" placeholder="Nama Lengkap Sesuai KTP">
                </div>
                  <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Nama Petugas yang Menerima Spesimen Klinis</label>
                  <input type="text" class="form-control" name="nama_ptgs_terima" id="inputName5" value="<?php echo $pecah['nama_ptgs_terima']?>" placeholder="Nama Lengkap Sesuai KTP">
                </div>
                  <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Nama Petugas yang Menganalisis Spesimen Klinis</label>
                  <input type="text" class="form-control" name="nama_ptgs_analis" id="inputName5" value="<?php echo $pecah['nama_ptgs_analis']?>" placeholder="Nama Lengkap Sesuai KTP">
                </div>
                  <div class="col-md-12" style="margin-top:10px;">
                  ...
                  <input type="datetime-local" class="form-control" name="waktu_uji_klinis" id="inputName5" value="<?php echo $pecah['waktu_uji_klinis']?>" placeholder="Waktu Pemeriksaan/Pengujian dan Pengolahan Spesimen Klinis">
                </div>

                  <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Nilai Hasil Pemeriksaan</label>
                  <input type="text" class="form-control" name="nilai_hasil" id="inputName5" value="<?php echo $pecah['nilai_hasil']?>" placeholder="Nilai hasil dari pemeriksaan spesimen">
                </div>
                  <div class="col-md-12" style="margin-top:10px;">
                  ...
                  <input type="text" class="form-control" name="nilai_rujuk" id="inputName5" value="<?php echo $pecah['nilai_rujuk']?>" placeholder="Nilai standar batas normal hasil pemeriksaan">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Nama Petugas yang Menganalisis Spesimen Klinis</label>
                  <input type="text" class="form-control" name="nilai_kritis" id="inputName5" value="<?php echo $pecah['nilai_kritis']?>" placeholder="Nilai ambang batas dari nilai rujukan">
                </div>

                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Interpretasi Hasil Pemeriksaan</label>
                  <input type="text" class="form-control" name="inter_hasil" id="inputName5" value="<?php echo $pecah['inter_hasil']?>" placeholder="Pembacaan oleh dokter spesialis di bidang laboratorium yang terkait">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Nama Dokter yang Memvalidasi Hasil Pemeriksaan</label>
                  <input type="text" class="form-control" name="dokter_valid" id="inputName5" value="<?php echo $pecah['dokter_valid']?>" placeholder="Nama lengkap dokter sesuai dengan kartu identitas, KTP">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Nama Dokter yang Menginterpretasi Hasil Pemeriksaan</label>
                  <input type="text" class="form-control" name="dokter_inter" id="inputName5" value="<?php echo $pecah['dokter_inter']?>" placeholder="Nama lengkap dokter sesuai dengan kartu identitas, KTP">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Waktu Hasil Pemeriksaan Keluar dari Laboratorium</label>
                  <input type="datetime-local" class="form-control" name="waktu_keluar" id="inputName5" value="<?php echo $pecah['waktu_keluar']?>" placeholder="Nilai ambang batas dari nilai rujukan">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  ...
                  <input type="datetime-local" class="form-control" name="waktu_terima_unit" id="inputName5" value="<?php echo $pecah['waktu_terima_unit']?>" placeholder="Nilai ambang batas dari nilai rujukan">
                </div>
                <div class="col-md-12" style="margin-top:10px;">
                  <label for="inputName5" style="margin-top: 10px;" class="form-label">Nama Fasilitas Kesehatan yang Melakukan Pemeriksaan</label>
                  <input type="text" class="form-control" name="nama_faskes_uji" id="inputName5" value="<?php echo $pecah['nama_faskes_uji']?>" placeholder="Nama Fasilitas Pelayanan Kesehatan yang melalukan pemeriksaan spesimen klinis jika spesimen klinis dirujuk">
                </div>
