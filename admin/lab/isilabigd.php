...
$ambil = $koneksi->query("SELECT * FROM lab WHERE id_lab_igd='$id' AND tgl='$tanggal'");
            ...
            <form class="row" method="post" enctype="multipart/form-data">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label for="inputName5" style="margin-top: 10px;" class="form-label">Tanggal</label>
                            <input type="date" class="form-control" name="tgl_hasil[]" id="inputName5" placeholder="Masukkan Nama Pasien" style="width: 1000px;" value="<?= $_GET['tgl'] ?>">
                            <p style="color:orangered;">*harap isi sesuai tgl rujuk lab</p>
                        </div>
                        <input type="hidden" class="form-control" name="id_inap[]" id="inputName5" value="<?php echo $pecah['id_lab_igd'] ?>" placeholder="Masukkan Nama Pasien">
                        <input type="hidden" class="form-control" name="id" id="inputName5" value="<?php echo $pecah['id_lab_igd'] ?>" placeholder="Masukkan Nama Pasien">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                        $result1 = $koneksi->query("SELECT sum(biaya) FROM lab WHERE id_lab_igd='$id' AND tgl='$tanggal';");
            ...
            for ($i = 0; $i < $jumlahFile; $i++) {
                ...
                foreach ($_POST['pasien'] as $value3) {
                    foreach ($_POST['norm'] as $value4) {
                        foreach ($_POST['id_inap'] as $value6) {
                            foreach ($_POST['petugas'] as $value5) {
                                foreach ($_POST['tgl_hasil'] as $value7) {
