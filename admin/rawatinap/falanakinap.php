...
if(isset($_POST['no8'])){
  ...
  $koneksi->query("INSERT INTO humpty_igd   
    ...
    (tgl, jenis_ket, usia, jk, diagnosis, kognitif, lingkungan, respon, medik, total_skor, jenis_skor, perawat, obat, no1, no2, no3, no4, no5, no6, no7, no8, pasien, no_rm, tgl_masuk, tipe)

    VALUES ('$_POST[tgl]', '$jenis_ket', '$_POST[usia]', '$_POST[jk]', '$_POST[diagnosis]', '$_POST[kognitif]', '$_POST[lingkungan]', '$_POST[respon]', '$_POST[medik]', '$_POST[total_skor]', '$_POST[jenis_skor]', '$perawat', '".$obat."', '$no1','$no2','$no3','$no4','$no5','$no6','$no7','$no8','$_POST[pasien]','$_POST[no_rm]', '$_POST[tgl_masuk]', 'inap')
