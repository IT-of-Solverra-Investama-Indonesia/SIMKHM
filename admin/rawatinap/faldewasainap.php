                            ...
                            <tbody>
                              ...
                              ?>
                                  <tr>
                                      ...
                                      <td><a href="index.php?halaman=faldewasainap&id=<?= $_GET['id']?>&idfr=<?= $data['id_morse']?>" class="btn btn-sm btn-primary"><i class="bi bi-eye"></i></a></td>
                                  </tr>
                              <?php }?>
                            </tbody>
                          </table>
        ...
        if(isset($_POST['save'])){
            ...
            echo "
                <script>
                    ...
                    document.location.href='index.php?halaman=faldewasainap&id=$_GET[id]&kunjungan=$_GET[kunjungan]';
                </script>
            ";
        }
    ?>
