        ...
        <div class="col-md-12">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <?php if(!empty($jumlah_pasien_hari['jadwal']) or !empty($jumlah_pasien_hari['antrian'])){ ?>
                        <div style="font-size: 2em; font-weight: bold; color: orangered"><?= $jumlah_pasien_hari['antrian']?></div>
                        <div style="font-size: 0.9em; font-weight: bold; color: darkred">(<?= $antrian['ket']?>)</div>
                        <div style="font-size: 0.9em; font-weight: bold; margin-top:3px">Mohon datang tepat waktu, bila terlambat, akan hangus dan antri ulang.</div>
                      <?php }else{ ?>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card info-card sales-card">
                <div class="card-body">
                  <h5 class="card-title">Jumlah Pasien Yang Datang: <span></span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                        $hari_ini = date('Y-m-d');
                        $jumlah_pasien_hari = $koneksi->query("SELECT idrawat FROM registrasi_rawat WHERE DATE_FORMAT(registrasi_rawat.jadwal, '%Y-%m-%d') = '$hari_ini' and perawatan = 'Rawat Jalan' and status_antri = 'Datang' and perawat = '' ")->num_rows;
                      ?>
                     
                     <?php if(!empty($jumlah_pasien_hari)){ ?>
                      <div style="font-size: 2em; font-weight: bold; color: darkgreen"><?= $jumlah_pasien_hari ?></div>
                      <?php }else{ ?>
            ...
            <div class="row">
            <div class="col-6">
                <a href="../pasien/daftarpasienlama.php" style="text-decoration:none; margin-top:18px; background-color:white; width:100%" class="btn btn-outline-success" id="btnn"><i class="bi bi-person-lines-fill" style="font-size: 1.5em; color:#157347;"></i><br>
                Pendaftaran
                </a>
            </div>
            <div class="col-6">
                  <a href="../pasien/riwayatdaftar.php" style="text-decoration:none; margin-top:18px; background-color:white; width:100%" class="btn btn-outline-success" id="btnn">
            ...
            <div class="col-12" style="margin-bottom:50px">
                  <a href="menupasien.php?logout" style="text-decoration:none; margin-top:18px; background-color:white; width:100%" class="btn btn-outline-success" id="btnn">
