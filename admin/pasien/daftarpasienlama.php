...
$kode .=$antrian;
  ...
  if($perawatan == "Rawat Inap"){
    ...
    $koneksi->query("INSERT INTO registrasi_rawat (nama_pasien, perawatan, jenis_kunjungan, id_pasien, no_rm, jadwal, antrian, status_antri, carabayar, kode, keluhan) VALUES ('$nama_pasien', '$perawatan', 'Kunjungan Sakit', '$id_pasien', '$no_rm', '$jadwal', '$antrian', 'Belum Datang', '$_POST[carabayar]','$kode', '$keluhan')");
  }
