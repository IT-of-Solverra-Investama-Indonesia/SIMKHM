              ...
              <div class="card-body">
                ...
                <form class="row g-3" method="post" enctype="multipart/form-data">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control"  name="nama_lengkap" id="inputName5" placeholder="Masukkan Nama Pasien">
                  </div> 
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control"  name="no_rm" id="inputName5" placeholder="Masukkan RM Pasien">
                  </div>
                  <div class="col-md-6">
                    <label for="inputName5" class="form-label">Tanggal Lahir</label>
                    <input type="date" class="form-control" name="tgl_lahir" id="inputName5" placeholder="Masukkan Nama Pasien">
                  </div>
                   <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="number" name="no_identitas" class="form-control" id="inputCity" placeholder="Masukkan No. Identitas Pasien">
                  </div>
