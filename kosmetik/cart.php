                        ...
                        <div class="product">
                            <div class="product-content" style="  display: flex;">
                                <a href="produk_kosmetik/<?= $product['foto'] ?>" target="_blank">
                                    <img class="product-image"
                                        ...
                                        src="produk_kosmetik/<?= $product['foto'] ?>"
                                        alt="<?php echo $product['produk']; ?>">
                                </a>
                                <div class="row">
                                    <h6 class="mb-1"><?php echo $product['produk']; ?></h6>
                                    <p class="card-text mb-0 mt-0">Rp.
                                        <?= number_format($product['harga'], 0, ',', '.') ?>,00 (Diskon
                                        <?php echo $product['diskon']; ?>% atau Rp <?= number_format(($product['harga'] * $product['jumlah']) * $product['diskon'] / 100, 0, '','.')?>)
                                    </p>
                                    <p class="mb-0"><?php echo $product['jumlah']; ?> Pcs</p>
                                    <h6 id="price" style=""><b>Sub : Rp
                                            <?php echo number_format($sub = $product['harga'] * $product['jumlah'] - (($product['harga'] * $product['jumlah']) * $product['diskon'] / 100), 0, ',', '.') ?></b>
                                    </h6>
                                    <?php $grandTotal += $sub; ?>
                            ...
                            <div class="quantity d-flex">
                                <div class="card-jumlah d-flex gap-2 mb-2 mr-2">
                                    ...
                                    <a href="index.php?halaman=cart&id=<?php echo $product['id'] ?>"
                                        onclick="return(confirm('Yakin menghapus cart yang dipilih?'))">
                        ...
                        <form method="post">
                            ...
                            <div class="mb-2">
                                ...
                                <textarea type="text" style="min-height: 150px;" name="alamat_lengkap" class="form-control border border-success" id="alamat"
                                    placeholder="Alamat Lengkap" value="">Provinsi <?= $_SESSION['kosmetik']['provinsi'] ?>, Kabupaten/Kota <?= $_SESSION['kosmetik']['kota'] ?>, Kecamatan <?= $_SESSION['kosmetik']['kecamatan'] ?>, Desa/Kelurahan <?= $_SESSION['kosmetik']['kelurahan'] ?>, <?= $_SESSION['kosmetik']['alamat'] ?>, <?= $_SESSION['kosmetik']['kode_pos'] ?>
                                </textarea>
                            </div>
                            <div>
                            ...
                            <?php if($_SESSION['kosmetik']['alamat'] == ''){?>
